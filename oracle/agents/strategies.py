...
from oracle.agents.base import SearchStrategy, AgentConfig
...
class StrategyConfig(BaseModel):
    ...
    verification_focus: str = Field(
        default="balanced",
        description="verification focus: balanced, confirming, disconfirming"
    )
...
STRATEGY_CONFIGS: dict[StrategyProfile, StrategyConfig] = {
    ...
    StrategyProfile.FOCUSED_OFFICIAL: StrategyConfig(
        ...
        temperature=0.05,
        preferred_domains=[
            ".gov", ".gov.uk", "sec.gov", "treasury.gov",
    ...
    StrategyProfile.NEWS_CENTRIC: StrategyConfig(
        ...
        preferred_domains=[
            ...
            "ft.com", "theguardian.com", "cnbc.com",
        ],
        category_weights={
            "news": 60,
            "official": 20,
    ...
    StrategyProfile.CRYPTO_FINANCIAL: StrategyConfig(
        ...
        preferred_domains=[
            ...
            "decrypt.co", "bloomberg.com", "wsj.com",
    ...
    StrategyProfile.ACADEMIC: StrategyConfig(
        ...
        temperature=0.1,
        preferred_domains=[
            ".edu", "arxiv.org", "scholar.google.com",
            "researchgate.net", "nature.com", "science.org",
        ],
        category_weights={
            "official": 40,
            "domain_specific": 40,
...
class StrategyFactory:
    ...
    def get_config(profile: StrategyProfile) -> StrategyConfig:
        ...
        if profile not in STRATEGY_CONFIGS:
            logger.warning(
                f"Unknown strategy profile: {profile}, using COMPREHENSIVE"
            )
